...
// mesela 6 icin ilk 6 terim toplamini recurse fonsiyonla cözelim 
...
const toplamlar = (n)=>{
 ...
 //* ORNEK: Girilen n. terimdeki kadar Fibonacci sayısini yazdıran fonksiyonu recursive olarak kodlayınız.
console.log("************ 5- RECURSION *************");

//? FIBONACCI terimleri:  0, 1, 1, 2, 3, 5, 8, 13, 21, ...
//!fibonacci dizisindeki ilk n. terimini bulma fonksiyonu
