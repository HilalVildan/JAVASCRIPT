...
const getUsers = async () => {
  try {
    const response = await fetch("https://api.tvmaze.com/search/shows?q=girls"); //hatalari görebilmek icin bu baglanti adresini
    //biraz kafamiza göre kestik ki hata kismini hem konsolda hem ekranda görebilelim. sonra düzelttik.
